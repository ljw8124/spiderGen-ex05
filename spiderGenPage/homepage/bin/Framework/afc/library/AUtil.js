...
AAwait.prototype.reg = function()
{
	this.count++;
};

AAwait.prototype.unreg = function()
{
	if(--this.count==0) 
	{
		this._reportDone();
...
AAwait.prototype.all = function(endCallback)
{
	if(this.count==0) 
	{
		endCallback();
...
AAwait.prototype._reportDone = function()
{
	this.endCallbacks.forEach(function(callback)
	{
		callback();
	});
