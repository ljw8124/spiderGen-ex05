...
QueryManager.prototype.registerReal = function(aquery, realField, keyArr, compArr, updateTypes, callback, afterUpdate)
{
...
//##########################################
	...
	if(cbObj && cbObj.func) cbRet = cbObj.func.call(this, queryData);
