...
AComponent.prototype.loadEventInfo = function(evtListener)
{
	...
	if(!evtClass) 
    {
        console.error(this.baseName+'Event is not defined.');
        return;
    }
...
{
	return AEvent.bindEvent(this.element, eventName, callback);
};
...
AComponent.prototype.setQueryInfo = function(qryName, blockName, dataKeyArr, index)
{
...
AComponent.prototype.loadQueryInfo = function(isAsyncQryLoad)
{
